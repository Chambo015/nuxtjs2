  ...
  return (
    <div className="w-[95%] md:w-[85%] lg:w-[70%] mx-auto pt-10 space-y-6">
      ...
      <div>
        ...
        безопасности персональных данных, предпринимаемые ИП Леонова Елизавета
        Дмитриевна (далее — Оператор).
        <br />
        ...
        Оператор может получить о посетителях веб-сайта http://ai-up.ru.
        <br />
        ...
        сети интернет по сетевому адресу http://ai-up.ru.
        <br />
        ...
        распространения).
        <br />
        2.10. Пользователь — любой посетитель веб-сайта http://ai-up.ru.
        <br />
        ...
        <br />
        <ul>
          <li data-list="bullet">фамилия, имя, отчество</li>
        ...
        уведомление на адрес электронной почты Оператора info@ai-up.ru с
        ...
        электронной почты на электронный адрес Оператора info@ai-up.ru с
        ...
        Оператору с помощью электронной почты info@ai-up.ru.
        <br />
        ...
        Интернет по адресу http://ai-up.ru/privacy.
      </div>
    </div>
  );
}
