    ...
    <section className="container mx-auto mt-[75px] ">
      ...
      <div className="flex gap-[50px] items-center mt-[25px]">
        ...
        <div className="grid grid-cols-2 shrink-0 grow gap-5 min-w-[50%]">
          <div
            className={cn(
              'rounded-[20px]  flex items-center justify-center py-8 px-9 transition-all duration-500 relative overflow-hidden h-[300px]',
          ...
          <div
            className={cn(
              'rounded-[20px] bg-[#F5F7F9] flex items-center justify-center py-8 transition-all duration-500 px-9 relative overflow-hidden',
          ...
          <div
            className={cn(
              'col-span-2 rounded-[20px] bg-[#F5F7F9] flex items-center justify-center py-8 transition-all duration-500 px-9 relative overflow-hidden h-[283px]',
        ...
        <ul className="space-y-4">
          <li className={cn("group flex gap-5 py-[15px] pl-[23px] relative before:absolute before:inset-y-0 before:left-0 before:w-[3px] before:h-full before:bg-primary/10 before:rounded-2xl [&.active-tab]:before:bg-primary ", activeTab === 0 && 'active-tab')} onMouseEnter={() => setActiveTab(0)}>
          ...
          <li className={cn("group flex gap-5 py-[15px] pl-[23px] relative before:absolute before:inset-y-0 before:left-0 before:w-[3px] before:h-full before:bg-primary/10 before:rounded-2xl [&.active-tab]:before:bg-primary ", activeTab === 1 && 'active-tab' )} onMouseEnter={() => setActiveTab(1)}>
            <div className="shrink-0 group-[.active-tab]:text-primary">
              <TimeTwentyFourIcon />
            </div>
            <div className="space-y-2.5">
          ...
          <li className={cn("group flex gap-5 py-[15px] pl-[23px] relative before:absolute before:inset-y-0 before:left-0 before:w-[3px] before:h-full before:bg-primary/10 before:rounded-2xl [&.active-tab]:before:bg-primary ", activeTab === 2 && 'active-tab')}  onMouseEnter={() => setActiveTab(2)}>
            <div className="shrink-0 group-[.active-tab]:text-primary">
