        ...
        <div data-aos="fade-up-left" className="grow max-md:overflow-hidden">
          ...
          <div className="mt-[15px]">
            ...
            <p className="text-sm text-white/60 mt-5">
              Результаты говорят сами за себя — с использованием нашего сервиса стоимость лидов в строительстве
              снизилась с 3 500 до 700 рублей, что означает 80% экономии. Мы привлекли больше лидов, сохранив тот же
              объем бюджета. Это не просто экономия, это революция в подходе к лидогенерации для строительных компаний.
            </p>
          </div>
        </div>
      </section>
