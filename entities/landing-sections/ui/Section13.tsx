    ...
    <section className="container mx-auto mt-[75px]">
      <div className='bg-black relative overflow-hidden rounded-[20px]'>
        ...
        <div className='relative z-10 p-[35px]'>
          ...
          <div className='grid grid-cols-2 justify-center gap-5 max-w-[830px] mx-auto mt-5 max-md:grid-cols-1'>
              {ModelSection13.map((item, idx) => <div data-aos="fade-up" data-aos-delay={50 * (idx + 1)} key={item.title} className='bg-[#F5F7F9]/40 backdrop-blur-sm rounded-[20px] pt-[18px] pb-[15px] px-[14px] max-w-[400px] max-md:max-w-full'>
